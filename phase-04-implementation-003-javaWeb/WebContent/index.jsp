...
<body class="background1">
	...
	<audio id="waiting" src="/static/audio/hetianxun.mp3" preload="auto" onended="onWaitingAudioEnd();"></audio>
	<div id="poem-txt"
	...
	<img src="/static/imgs/earth.png"
		style="position: absolute; right: 10px; top: 10px; width: 250px"
	...
	<div id="hornor" style="display:none;position:absolute;left:10x; bottom:10x;color:white;font-size:24px" align="center">2019年发生了很多大事，谨以此向<span style="color:red">《流浪地球》</span>和<span style="color:orange">华为公司</span>表示致敬 !  <br/>本网页未来将放在以下网站 sdlc.huaku-2019.xyz (华为公司的云服务器) <br/> huaku-2019, 2019 年，《流浪地球》 和华为很酷！ <br/>也许华为的崛起意味着，在人类未来需要流浪地球时，东方大国将作出巨大的贡献 ！</div>
	<div id="my_intr" style="display:none;position:absolute;left:10x; bottom:10x;color:white;font-size:24px" align="left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp我最喜欢在夜晚站在阳台，仰望那璀璨的星空。</br>星空里的星变幻无常，各个星组成了一个个美丽的形</br>状。看着他们，无论多么烦躁的心情都能平静下来。</br>陶醉在其中，是一种很美好的境界，仿佛星空就在我</br>眼前，伸手就可触摸到，这时候是我最平静的时候。</br>当你烦躁时，记得仰望星空，星空会抚平你心中的烦</br>躁。</br>———黄泽鸿</div>
</body>
</html>